    ...
    <ul class="nav navbar-nav">
      <li class="nav-item">
        <a class="navbar-brand" href="<?php print $front_page ?>">
          ...
          <h2 class="brand-text mb-0">Phần mềm quản lý tàu</h2>
        </a>
      </li>
    </ul>
  </div>
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        ...
        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
          <li class="dropdown-menu-header">
            <div class="dropdown-header d-flex">
              ...
              <div class="badge rounded-pill badge-light-primary">6 Thông báo
                mới
              </div>
            </div>
          </li>
              ...
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #03994 </span>&nbsp;quá hạn
                    5 ngày
                  </p>
                  <small class="notification-text">Hạn HĐ: 01/11/2022</small>
                </div>
              </div>
            </a>
            <a class="d-flex" href="#">
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #039092</span>&nbsp;quá hạn
                    3 ngày
                  </p>
                  <small class="notification-text"> Hạn HĐ: 10/11/2022</small>
                </div>
              </div>
            </a>
            <a class="d-flex" href="#">
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #09494 </span>&nbsp;gần hết
                    hạn
                  </p>
                  <small class="notification-text"> Hạn HĐ: 01/12/2022</small>
                </div>
              </div>
            </a>
          </li>
      ...
      <li class="nav-item dropdown dropdown-user">
        <a class="nav-link dropdown-toggle dropdown-user-link"
          ...
          <span class="avatar">
            <img class="round"
                 src="<?= drupal_get_path('theme', 'quan_ly_tau_theme') ?>/app-assets//images/portrait/small/avatar-s-11.jpg"
      ...
      <ul class="nav navbar-nav flex-row">
        <li class="nav-item me-auto">
          <a class="navbar-brand" href="#">
            ...
            <h2 class="brand-text mb-0">Quản lý Hợp đồng</h2>
          </a>
        </li>
