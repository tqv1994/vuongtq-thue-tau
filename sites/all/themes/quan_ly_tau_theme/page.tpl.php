    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
          ...
          <li class="scrollable-container media-list">
              ...
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #03994 </span>&nbsp;quá hạn 5 ngày
                  </p>
            ...
            <a class="d-flex" href="#">
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #039092</span>&nbsp;quá hạn 3 ngày
                  </p>
            ...
            <a class="d-flex" href="#">
              <div class="list-item d-flex align-items-start">
                ...
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading">
                    <span class="fw-bolder">Hợp đồng #09494 </span>&nbsp;gần hết hạn
                  </p>
      ...
      <li class="nav-item dropdown dropdown-user">
        <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <span class="avatar">
            <img class="round" src="<?=drupal_get_path('theme', 'hopdong')?>/app-assets//images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
